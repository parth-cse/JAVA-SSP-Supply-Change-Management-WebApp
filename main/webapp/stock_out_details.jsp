    ...
    <table>
        ...
        <%
            try {
                ...
                String sql = "SELECT s.stock_out_id, p.product_name, s.quantity, s.date_out, s.order_id FROM stock_out s JOIN products p ON s.product_id = p.product_id ORDER BY date_out;";
                PreparedStatement stmt = conn.prepareStatement(sql);
                ResultSet rs = stmt.executeQuery();

                while (rs.next()) {
                    int productId = rs.getInt("stock_out_id");
                    String productName = rs.getString("product_name");
                    int availableQuantity = rs.getInt("quantity");
                    String date = rs.getString("date_out");
...
<div class="return"><p>Return <a href="/Project/">Home</a></p><p>|</p><p><a href="/stock_out_form.jsp">Add Stock out Entry</a></p></div>
    <footer>
