    ...
    <table>
        ...
        <%
            try {
                ...
                String sql = "SELECT s.stock_in_id, p.product_name, s.quantity, s.date_in FROM stock_in s JOIN products p ON s.product_id = p.product_id ORDER BY date_in;";
                PreparedStatement stmt = conn.prepareStatement(sql);
                ResultSet rs = stmt.executeQuery();

                while (rs.next()) {
                    int productId = rs.getInt("stock_in_id");
                    String productName = rs.getString("product_name");
                    int availableQuantity = rs.getInt("quantity");
                    String date = rs.getString("date_in");
        %>
        <tr>
            <td><%= productId %></td>
            <td><%= productName %></td>
...
<div class="return"><p>Return <a href="/Project/">Home</a></p><p>|</p><p><a href="./stockInEntry.jsp">Add Stock in Entry</a></p></div>
    <footer>
