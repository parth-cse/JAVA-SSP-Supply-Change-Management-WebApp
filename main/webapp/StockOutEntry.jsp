...
<body>
    ...
    <form action="StockOutServlet" method="post" class="add-material-form">
        <h1>Stock Entry</h1>
        ...
        <option disabled selected value>Select Product</option>
            <%
                try {
                    ...
                    String sql = "SELECT product_id, product_name FROM products Where category='finished_product'";
        ...
        <option disabled selected value>Select Order Id</option>
            <%
                try {
                    ...
                    // Fetch product names from the database
                    String sql = "SELECT order_id FROM orders Where order_status='pending'";
                    PreparedStatement stmt = conn.prepareStatement(sql);
                    ResultSet rs = stmt.executeQuery();
