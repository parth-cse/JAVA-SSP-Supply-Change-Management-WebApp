    ...
    <table>
        ...
        <%
            try {
                ...
                String sql = "SELECT o.order_id, p.product_name, o.customer_name, o.order_date FROM orders o JOIN products p ON o.product_id = p.product_id WHERE order_status='completed';";
